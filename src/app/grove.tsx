...
export default function Grove(){
  ...
  var _beds=st(function(){
    var arr=[];
    for(var i=0;i<14;i++){
      arr.push({id:i,name:"Bed "+(i+1),shape:i===13?"circle":"rect",sun:i<9?"full":"shade",grid:Array(20).fill(null),
        ph:i===6?[{d:"Jul 18",inp:6.5,run:5.9},{d:"Jul 10",inp:6.4,run:6.2}]:[]});
    }
    return arr;
  ...
  var _myp=st([
    {id:1,name:"Sungold Tomato",e:"\u{1F345}",bed:"Bed 3",planted:"2026-04-15",dth:65},
    {id:2,name:"French Radish",e:"\u{1F534}",bed:"Bed 14",planted:"2026-06-01",dth:25},
    {id:3,name:"Lacinato Kale",e:"\u{1F957}",bed:"Bed 9",planted:"2026-05-01",dth:60},
    {id:4,name:"Nantes Carrot",e:"\u{1F955}",bed:"Bed 10",planted:"2026-05-20",dth:70},
    {id:5,name:"Babcock Peach",e:"\u{1F351}",bed:"Tree Row",planted:"2026-03-01",dth:120},
  ]),myPlants=_myp[0],setMyPlants=_myp[1];
  ...
  return <div style={{background:G.bg0,color:G.t1,fontFamily:"-apple-system,Inter,system-ui,sans-serif",minHeight:"100vh",maxWidth:430,margin:"0 auto"}}>
    <div style={{padding:"11px 16px 9px",display:"flex",justifyContent:"space-between",alignItems:"center",borderBottom:"1px solid "+G.ln}}>
      ...
      <div style={{display:"flex",alignItems:"center",gap:8}}><span style={{fontSize:9,color:G.s2,fontWeight:600,border:"1px solid "+G.s2+"44",borderRadius:99,padding:"2px 8px"}}>9B</span><span style={{fontSize:13}}>{FC[0].i}</span><span style={{fontSize:12,fontWeight:600}}>{FC[0].h+"\u00B0"}</span></div>
    </div>
    ...
    {tab==="home"&&<div style={{display:"flex",flexDirection:"column",gap:12}}>
      ...
      <Card style={{borderColor:G.warn+"33",background:G.warn+"06",padding:11}}><div style={{color:G.warn,fontSize:11,fontWeight:600}}>Heat wave Thu-Fri</div><div style={{color:G.t2,fontSize:10}}>Extra evening water for full-sun beds.</div></Card>
    ...
    {tab==="water"&&<div style={{display:"flex",flexDirection:"column",gap:10}}>
      ...
      {!controller?<>
        ...
        <Card style={{padding:11}}><div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}><div><div style={{fontSize:11,fontWeight:600,color:G.s2}}>{"\u{1F326}\uFE0F Weather-Smart"}</div><div style={{color:G.t2,fontSize:10,marginTop:2}}>Today: 94\u00B0F, no rain. ET high.</div></div><div style={{textAlign:"right"}}><div style={{color:G.c2,fontSize:11,fontWeight:600}}>+15% runtime</div><div style={{color:G.t4,fontSize:9}}>heat adjust</div></div></div></Card>
