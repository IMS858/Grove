      ...
      {eB!==null?(function(){var b=beds.find(function(x){return x.id===eB});if(!b)return null;var sh=getShape(b.shape);var cells=sh.w*sh.h;return <div>
        ...
        return <div style={{display:"flex",flexDirection:"column",gap:10}}>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
            ...
            <button onClick={function(){setYardMode(false);setYardSel(null)}} style={{background:"none",border:"1px solid "+G.ln,borderRadius:8,color:G.t3,fontSize:11,padding:"5px 12px",cursor:"pointer"}}>Done</button>
          </div>
