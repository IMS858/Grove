    ...
    {tab==="garden"&&<div style={{display:"flex",flexDirection:"column",gap:10}}>
      {eB!==null?(function(){var b=beds.find(function(x){return x.id===eB});if(!b)return null;var sh=getShape(b.shape);var cells=sh.w*sh.h;return <div>
        ...
        return <div style={{display:"flex",flexDirection:"column",gap:10}}>
          ...
          <div style={{color:G.t3,fontSize:10,lineHeight:1.5}}>Drag pieces to match your real yard. Tap a piece to select, then rotate, resize, rename, or delete it. Tap empty space to add the selected tool.</div>
          {/* The canvas */}
